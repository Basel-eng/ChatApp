            ...
            <div className="md:w-full p-8 flex items-center justify-center  border-slate-600/30">
              <div className="w-full max-w-md">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  {/* SUBMIT BUTTON */}
                  <button
                    className="w-full flex items-center justify-center cursor-pointer bg-cyan-500 text-white rounded-lg py-2.5 font-medium hover:bg-cyan-600 focus:ring-2 focus:ring-cyan-500 disabled:opacity-50"
                    type="submit"
                    disabled={isLogginIn}
                  >
                    {isLogginIn ? (
